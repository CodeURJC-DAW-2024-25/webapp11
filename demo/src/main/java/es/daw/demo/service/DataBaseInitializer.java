...
public class DataBaseInitializer{
    ...
    public void initializeDatabase() throws IOException {
        ...
        User user1 = new User("Pepe", "García", "pepegarcia@gmail.com", passwordEncoder.encode("1234"), "Informática");
        User user2 = new User("Juan", "López", "juanlopez@gmail.com", passwordEncoder.encode("2345"), "Informática");
